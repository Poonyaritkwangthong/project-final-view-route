      ...
      <form action="{{ route('news.update',$news->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-12 mt-8">
          <div class="border-b border-gray-900/10 pb-12">
            ...
            <a href="{{ route('news.index') }}"><button type="button" class="mt-2 rounded-md bg-yellow-400 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Back</button></a>
              ...
              <div class="col-span-full">
                ...
                <div class="mt-2">
                    <input name="name_news" value="{{ $news->name_news }}" type="text" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 p-2" placeholder="โปรดเเจ้งหัวข้อข่าวประจำหมู่บ้าน.">
                    @error('name_news')
              ...
              <div class="col-span-full mt-4">
                ...
                <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                  <div class="text-center">
                    ...
                    <img class="" id="output" src="{{ asset('/images/news/'.$news->n_img) }}" alt=""/>
                        <script>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <input id="about" type="text" name="n_location" value="{{ $news->n_location }}" placeholder="โปรดระบุตำเเหน่งข่าว." class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 p-2"></input>
              @error('n_location')
              <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <input id="about"  type="text" name="n_detail" value="{{ $news->n_detail }}" placeholder="โปรดเเจ้งลายระเอียดของข่าว." class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-2"></input>
              @error('p_detail')
              <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <input id="about"  type="date" name="n_date" value="{{ $news->n_date }}" placeholder="โปรดระบุวันที่ข่าว." class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 p-2"></input>
              @error('n_date')
              <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
              @enderror
            </div>
