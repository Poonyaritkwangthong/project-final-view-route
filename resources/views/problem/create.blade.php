      ...
      <form action="{{ route('problem.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-12 mt-8">
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <textarea id="about"  type="text" name="p_detail" placeholder="โปรดเเจ้งลายระเอียดของปัญหา." class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
              @error('p_detail')
              <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
              @enderror
            </div>
